...
def build_config(
    ...
    *,
    ...
    ini = [
        ...
        "",
        "[EMCIO]",
        "# CETTE LIGNE EST INDISPENSABLE, et son absence ne provoque aucune",
        "# erreur. Dans emc/task/taskclass.cc :",
        "#",
        "#     use_iocontrol = (inifile.Find(\"EMCIO\", \"EMCIO\") != NULL);",
        "#",
        "# la tache decide d'employer le controleur d'entrees-sorties sur la",
        "# seule PRESENCE de la cle. Le script de demarrage, lui, a sa propre",
        "# valeur par defaut ('io') et lance le controleur quand meme. Sans",
        "# cette ligne, les deux divergent : 'io' tourne, ses broches HAL",
        "# existent et repondent, la boucle d'arret d'urgence se ferme — et la",
        "# tache, qui l'ignore, ne quitte JAMAIS l'arret d'urgence. La machine",
        "# ne peut pas etre mise en marche, sans un seul message d'erreur.",
        "EMCIO = io",
        "TOOL_TABLE = tool.tbl",
